...
with receitas_mensais as (
    ...
    from
        "northwind"."public"."stg_orders" as orders
    inner join
        "northwind"."public"."stg_orders_details" as order_details on orders.order_id = order_details.order_id
    group by
...
select * from report_receitas_acumuladas